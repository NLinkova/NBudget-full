...
precacheAndRoute(self.__WB_MANIFEST); //check this and add routes
...
registerRoute(
  ...
  createHandlerBoundToURL(process.env.PUBLIC_URL + "/index.html") //entry point to the app
);

//caching strategy. add other for js, html and more
